...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 30 Bulan Mei 2024 pada 10.28
...
INSERT INTO `pengaduan_perbaikan_detail` (`id_pengaduan_perbaikan_detail`, `id_pengaduan_perbaikan`, `id_barang`, `keterangan`, `jumlah`, `tgl_pengerjaan`, `status`) VALUES
(3, 3, 64, 'Lemut dan tidak konek internet', 1, '2024-05-11', 'Selesai'),
(6, 6, 64, 'Lemut', 1, '2024-01-03', 'Selesai');
...
(25, 'safiuddin', '$2y$10$tcWpuiGVBm8K4wCSSnkdNufeWRbPwMbpS9zfcs3TDHdX3dlnfpaOO', 'teknisi'),
(26, 'rafatar', '1', 'karyawan'),
(27, '1', '$2y$10$WIPQKm8q5bKhHu/WkAlj0OmPBvUetzC8OsvqiJF5xIZtTR.JxhXVe', 'karyawan');
...
INSERT INTO `perbaikan_detail` (`id_perbaikan_detail`, `id_pengaduan_perbaikan_detail`, `tgl_proses`, `tgl_selesai`, `id_teknisi`, `analisa`, `id_rincian_biaya`, `total_biaya`, `status`) VALUES
(1, 1, '2024-05-25', '2024-05-23', 1, '1', 1, 1, 'Pending');
...
--
ALTER TABLE `barang`
  MODIFY `id_barang` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=72;
...
--
ALTER TABLE `barang_masuk`
  MODIFY `id_barang_masuk` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=64;

--
-- AUTO_INCREMENT untuk tabel `barang_masuk_detail`
--
ALTER TABLE `barang_masuk_detail`
  MODIFY `id_barang_masuk_detail` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
...
--
ALTER TABLE `pengaduan_perbaikan`
  MODIFY `id_pengaduan_perbaikan` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT untuk tabel `pengaduan_perbaikan_detail`
--
ALTER TABLE `pengaduan_perbaikan_detail`
  MODIFY `id_pengaduan_perbaikan_detail` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT untuk tabel `pengguna`
--
ALTER TABLE `pengguna`
  MODIFY `id_pengguna` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
...
--
ALTER TABLE `perbaikan_detail`
  MODIFY `id_perbaikan_detail` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `teknisi`
  MODIFY `id_teknisi` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
