    ...
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="col-sm-12">
                                          ...
                                          Add Barang Masuk
                                            ...
                                            <div class="card-body">                                
                                              <div class="container">
                                                    <form action="../barang/simpan_barang_masuk.php" method="post">
                                                      <div>
                                                      <label for="tgl_barang_masuk">Tanggal Barang Masuk:</label>
                                                      <input type="date" id="tgl_barang_masuk" name="tgl_barang_masuk" class="form-control"  ><br>
                                                      ...
                                                      <input type="number" id="id_poli" name="id_poli" class="form-control" autocomplete="off" required><br>
                                                      <br>
           ...
           ?>
            ...
            <script>
                    ...
                    const tglInput = document.getElementById('tgl_barang_masuk');
